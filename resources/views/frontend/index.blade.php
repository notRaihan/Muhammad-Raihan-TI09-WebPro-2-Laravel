        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="row gx-0 mb-4 mb-lg-5 align-items-center">
                <div class="col-xl-8 col-lg-7"><img class="img-fluid mb-3 mb-lg-0"
                        src="{{ asset('front/assets/img/bg-masthead.jpg') }}" alt="..." /></div>
            ...
            <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                <div class="col-lg-6"><img class="img-fluid" src="{{ asset('front/assets/img/demo-image-01.jpg') }}"
                        alt="..." /></div>
                <div class="col-lg-6">
            ...
            <div class="row gx-0 justify-content-center">
                <div class="col-lg-6"><img class="img-fluid" src="{{ asset('front/assets/img/demo-image-02.jpg') }}"
                        alt="..." /></div>
